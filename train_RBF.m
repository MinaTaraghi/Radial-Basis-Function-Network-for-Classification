function [Centers, sigma, Ws] = train_RBF(train_x, train_y, centersPerCategory,func,train_mode,nEBF,center_selection,useKmeans,lambda)
...
for c=1:classNo
    ...
    Ws=train_RLS(Phis,lambda,train_y,classNo);
end
end